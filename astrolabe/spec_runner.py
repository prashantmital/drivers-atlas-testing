...
class AtlasTestCase:
    ...
    def initialize(self):
        ...
        specification.
        """
        # Create a cluster of the desired name with the given config.
    ...
    def run(self):
        ...
        print("Running test {} on cluster {}.".format(self.id, self.cluster_name))
        ...
        print("Workload executor running. PID: {}".format(worker_subprocess.pid))
